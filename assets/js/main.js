...
(function () {
  ...
  const toggleDarkMode = () => {
    ...
    if (document.body.classList.contains("dark-mode")) {
      ...
      icon.classList.add("bx-sun"); // Cambia el icono al sol
    } else {
      icon.classList.remove("bx-sun");
      icon.classList.add("bx-moon"); // Cambia el icono a la luna
    }
  ...
  // Añade un event listener para el botón de modo oscuro
  document.querySelector("#icon").addEventListener("click", toggleDarkMode);

  // Configuración inicial del modo oscuro basado en la preferencia almacenada
  window.addEventListener("load", () => {
